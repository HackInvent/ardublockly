...
Blockly.Msg.ARD_SERIAL_SETUP = "Configuration du port ";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "Choisir la vitesse d'un périphérique série";
Blockly.Msg.ARD_SERIAL_SPEED = ":  avec la vitesse";
...
Blockly.Msg.HI_BUTTON = "Tinker Button lire";
Blockly.Msg.HI_POTENTIOMETER = "Tinker Potentiometer lire";
Blockly.Msg.HI_RGBLED = "Tinker RGB LED";
Blockly.Msg.HI_SETBLUE = "pin bleu à";
Blockly.Msg.HI_SETGREEN = "pin vert à";
Blockly.Msg.HI_SETINTENSITY = "fixer l'intensité à";
Blockly.Msg.HI_SETLED = "Pour la TinkerLED connecée à";
Blockly.Msg.HI_SETLED_TIP = "Pour contrôler une LED";
Blockly.Msg.HI_SETRED = "pin rouge à";
Blockly.Msg.HI_SETSTATE = "Fixer l'état à ";
Blockly.Msg.HI_SETVAULE = "value to";
Blockly.Msg.INLINE_INPUTS = "Entrées en ligne";
Blockly.Msg.LED_RANGE_WARNING = "La valeur de l'intenstité doit être entre 0 et 255";
...
Blockly.Msg.VARIABLES_SET = "fixer la valeur de %1 à %2";
